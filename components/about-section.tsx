              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    Comencé mi carrera en desarrollo web hace más de 5 años, y desde entonces he trabajado en proyectos
                    que van desde startups hasta empresas Fortune 500. Mi enfoque siempre ha sido crear código limpio,
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    técnicos y explorar nuevas tecnologías que puedan mejorar la experiencia del desarrollador.
                  </p>
                </div>
